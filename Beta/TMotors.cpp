...
//Var Handlers
    ...
    //SendControl
        // void TMotors::SetSendControl(SendControl sc,int v){
        //     SendControl=sc;
        //     VSetting=v;
        // }
        // void TMotors::SetSendControl(SendControl sc){
        //     SendControl=sc;
        // }
        // enum SendControl TMotors::GetSendControl(){
        //     return SendControl;
        // }
    //Velocity
    ...
    //Target
        ...
        void TMotors::SetTargetSetting(double tar,int v){
            TargetSetting=tar;
            VSetting=v;
        }
